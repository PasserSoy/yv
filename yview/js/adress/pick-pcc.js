    ...
    Plugin.prototype = {
        ...
        render:function(){
            ...
            if(setFormat){
                ...
                if(setFormat.match("province")){
                    ...
                    if(slash==0){
                        strSpan = '<span title='+areaArr[0]+'  class="pick-province">'+areaArr[0]+'</span>';
                        this.format = "p";
                    } else if(slash==1){
                        strSpan = '<span title='+areaArr[0]+' class="pick-province">'+areaArr[0]+'</span>'+
                            '<i>/</i>'+
                            '<span title='+areaArr[1]+' class="pick-city">'+areaArr[1]+'</span>';
                        this.format = "p/c";
                    } else if(slash==2){
                        strSpan = '<span title='+areaArr[0]+' class="pick-province">'+areaArr[0]+'</span>'+
                            '<i>/</i>'+
                            '<span title='+areaArr[1]+' class="pick-city">'+areaArr[1]+'</span>'+
                            '<i>/</i>'+
                            '<span title='+areaArr[2]+' class="pick-county">'+areaArr[2]+'</span>';
                        this.format = "p/c/c";
                    }
                    contentStr = '<div class="pick-show">'+
        ...
        setVal:function(_thisP,aim,s){
            ...
            if(s=="pro"){
                ...
                this.ele.find(".pressActive").attr('title',$(aim).html());
                if($(aim).html()=="请选择省"){
